...
import { VideoSkeleton } from './VideoSlide';

const Skeleton = () => {
  return (
    <div className='flex flex-col gap-8 md:gap-16 min-h-[400px] bg-white rounded-xl mt-[30px] mb-[90px] md:mt-[80px] md:mb-[120px] px-5 py-4 md:px-10 md:py-8'>
